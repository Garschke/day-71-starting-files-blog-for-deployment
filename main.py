...
class User(UserMixin, db.Model):
    ...
    # Parent relationship: "comment_author" refers to the comment_author
    # property in the Comment class.
...
class Comment(db.Model):
    ...
    # Child relationship:"users.id" The users refers to the tablename of the
    # User class.
...
# DON'T put your email and password here directly! The code will be visible
...
def send_email(name, email, phone, message):
    ...
    with smtplib.SMTP(EMAIL_PROVIDER_SMTP_ADDRESS, port=587) as connection:
        ...
        connection.sendmail(EMAIL_ADDRESS, "andrew.garschke@me.com", email_message)
